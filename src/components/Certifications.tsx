...
import { Award, ExternalLink, CheckCircle2, CalendarCheck, ShieldCheck } from 'lucide-react';
                ...
                >
                  ...
                  <div className={`relative bg-gradient-to-br ${cert.badgeBg} p-8 flex flex-col items-center justify-center min-h-[220px] sm:min-h-[260px]`}>
                    ...
                    <div className="relative z-10 mt-4 flex items-center gap-1.5">
                      ...
                      <span className="text-white/80 text-xs font-bold uppercase tracking-widest">{cert.issuer}</span>
                    </div>
                  </div>
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">
                      {cert.skills.map((skill) => (
                        <span key={skill} className={`px-2.5 py-1 rounded-lg text-xs font-semibold ${c.tag}`}>
                          {skill}
                        </span>
                      ))}
                    </div>

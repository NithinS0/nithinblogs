  ...
  return (
    ...
    >
      {!hasError && icon ? (
        ...
        <span
          className={`w-2 h-2 rounded-full bg-gradient-to-r ${color} animate-pulse shadow-[0_0_6px_rgba(96,165,250,0.3)] dark:shadow-[0_0_6px_rgba(96,165,250,0.6)]`}
        />
      )}
      <span className="text-slate-600 dark:text-gray-400 group-hover/chip:text-slate-900 dark:group-hover/chip:text-white font-semibold text-xs sm:text-sm transition-colors duration-300">
        {name}
      </span>
    </div>
  );
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "MLflow",
          icon: "https://avatars.githubusercontent.com/u/41551329?s=200&v=4",
        },
        {
          name: "CUDA",
          icon: "https://icons.veryicon.com/png/o/business/vscode-program-item-icon/cuda.png",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      iconBg:
        "bg-orange-500/10 group-hover:bg-orange-500/20 border-orange-500/20",
      skills: [
        {
          name: "FastAPI",
        ...
        {
          name: "Render",
          icon: "https://avatars.githubusercontent.com/u/32773170?s=200&v=4",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      textColor:
        "from-amber-600 to-orange-600 dark:from-yellow-400 dark:to-orange-400",
      ...
      iconBg:
        "bg-yellow-500/10 group-hover:bg-yellow-500/20 border-yellow-500/20",
      skills: [
        {
          name: "Docker",
        ...
        {
          name: "CI/CD",
          icon: "https://www.edgescan.com/wp-content/uploads/2022/12/CI-CD2.png",
        },
      ],
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {skillCategories.map((category, idx) => (
              ...
              >
                ...
                <div
                  className={`absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r ${category.color} opacity-70 group-hover:opacity-100 transition-opacity duration-500`}
                />

                {/* Header */}
                <div className="flex items-center gap-4 mb-6 sm:mb-8">
                  <div
                    className={`p-3 rounded-2xl ${category.iconBg} border shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}
                  >
                    <category.icon size={22} className={category.iconColor} />
                  </div>
                  <h3
                    className={`text-lg sm:text-xl font-black bg-gradient-to-r ${category.textColor} bg-clip-text text-transparent group-hover:brightness-110 transition-all`}
                  >
                    {category.title}
                  </h3>
                </div>

  ...
  const experiences = [
    {
      ...
      description:
        "AI-driven process monitoring and full-stack system architecture for industrial systems. Spearheaded the QR-enabled smart inventory system and deployed computer vision WET monitoring on Raspberry Pi.",
      tags: [
        "Full-Stack",
        "QR Tracking",
        "Firebase",
    ...
    },
    {
      ...
      headerClass:
        "bg-gradient-to-br from-[#c0392b] via-[#922b21] to-[#1a1a2e]",
      ...
      description:
        "Designed RPA workflows and custom data visualization solutions to automate manufacturing business processes. Engineered Excel Macros, Power Apps pipelines, and interactive Power BI dashboards.",
      tags: ["RPA", "Excel Macros", "Power BI", "Power Apps", "Automation"],
      tagHoverClass:
        "hover:bg-red-500/10 hover:text-red-500 dark:hover:text-red-400 hover:border-red-500/30",
    },
  ];
            ...
            {experiences.map((exp, idx) => {
              ...
              return (
                ...
                >
                  {/* Card Header */}
                  <div
                    className={`p-7 pb-6 relative text-white ${exp.headerClass} flex flex-col`}
                  >
